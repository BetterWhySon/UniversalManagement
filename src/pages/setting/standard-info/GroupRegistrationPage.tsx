...
const GroupRegistrationPage: React.FC = () => {
  ...
  const dummyData: GroupData[] = [
    { id: 1, code: 'Group1', group: '서울권역', postcode: '06234', address: '서울시 강남구 테헤란로 123', detailAddress: '7층 701호', description: '서울 지역 그룹' },
    { id: 2, code: 'Group2', group: '경기권역', postcode: '13494', address: '경기도 성남시 분당구 판교로 234', detailAddress: '판교테크원타워 5층', description: '경기도 지역 그룹' },
    { id: 3, code: 'Group3', group: '인천권역', postcode: '21994', address: '인천시 연수구 송도문화로 345', detailAddress: '송도빌딩 3층', description: '인천 지역 그룹' },
    { id: 4, code: 'Group4', group: '부산권역', postcode: '48058', address: '부산시 해운대구 센텀중앙로 456', detailAddress: '센텀프라자 8층', description: '부산 지역 그룹' },
    { id: 5, code: 'Group5', group: '대구권역', postcode: '41585', address: '대구시 동구 동대구로 567', detailAddress: '동대구빌딩 2층', description: '대구 지역 그룹' },
    { id: 6, code: 'Group6', group: '광주권역', postcode: '61947', address: '광주시 서구 상무중앙로 678', detailAddress: '상무플라자 4층', description: '광주 지역 그룹' },
    { id: 7, code: 'Group7', group: '대전권역', postcode: '34126', address: '대전시 유성구 대학로 789', detailAddress: '유성빌딩 6층', description: '대전 지역 그룹' },
    { id: 8, code: 'Group8', group: '울산권역', postcode: '44677', address: '울산시 남구 삼산로 890', detailAddress: '삼산타워 9층', description: '울산 지역 그룹' },
    { id: 9, code: 'Group9', group: '강원권역', postcode: '24347', address: '강원도 춘천시 춘천로 901', detailAddress: '춘천빌딩 1층', description: '강원 지역 그룹' },
    { id: 10, code: 'Group10', group: '경기북부권역', postcode: '10364', address: '경기도 고양시 일산동구 중앙로 112', detailAddress: '일산타워 7층', description: '경기 북부 지역 그룹' },
    { id: 11, code: 'Group11', group: '충북권역', postcode: '28525', address: '충북 청주시 상당구 상당로 223', detailAddress: '상당빌딩 3층', description: '충북 지역 그룹' },
