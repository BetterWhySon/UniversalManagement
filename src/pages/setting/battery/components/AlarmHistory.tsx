...
const AlarmHistory: React.FC<AlarmHistoryProps> = ({ pageSize = 8 }) => {
  ...
  const dummyData: AlarmHistory[] = [
    ...
    { id: 17, 사업장: 'FF캠핑카', 그룹: 'Bayrun 640', 기기: 'VABJ023', 팩ID: 'B02', 알람구분: '과전���', 알람레벨: '위험', 발생일시: '2023-12-12 15:16', 알람내용: '배터리 과전류 발생', 측정데이터: '115A', 정상범위: '0A~100A', 해제일시: '2023-12-12 16:16', 해제측정데이터: '95A', 알람지속시간: '1h', 알람상태정보: '해제' },
