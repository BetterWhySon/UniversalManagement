    ...
    return (
      <div>
        <div className="flex mb-2">
          <h3 className="text-white w-[100px] pt-1">차트 항목</h3>
          <div className="flex-1 grid grid-cols-7 gap-y-1.5 gap-x-2 h-[72px]">
            <CheckboxItem name="운영 시간 비율(%)" />
            <CheckboxItem name="평균 파워 비율(%)" />
            <CheckboxItem name="운영 횟수 비율(%)" />
            <CheckboxItem name="고속/완속 사용비율(%)" />
            <CheckboxItem name="급속/완속 충전 비율(%)" />
            <CheckboxItem name="SOC 사용 구간비율(%)" />
          </div>
        </div>
      </div>
    );
