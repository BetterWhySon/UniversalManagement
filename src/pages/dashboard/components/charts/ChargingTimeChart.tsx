...
const ChargingTimeChart: React.FC = () => {
  ...
  const [chargingTimeData] = useState([
    { id: '68사1744', time: 800 },
    { id: '13모3878', time: 120 },
    { id: '07바4727', time: 114 },
    { id: '82라1810', time: 84 },
  ...
  return (
    <div className="bg-hw-dark-2 p-3 rounded-lg border border-white h-full flex flex-col">
      ...
      >
        {trans("충전 완료 후, 경과시간 (시간)")}
      </h3>
      <div className="flex-grow">
        <BarChart data={chargingTimeData} isTimeData={true} onBarClick={handleBarClick} />
      </div>
      {selectedVehicle && (
...
export default ChargingTimeChart;
