...
const ChargingLevelChart: React.FC = () => {
  ...
  // 임시 데이터
  const [chargingLevelData] = useState([
    { id: '66어1468', soc: 7 },
    { id: '64머1189', soc: 5 },
    { id: '60가1343', soc: 5 },
    { id: '58허3067', soc: 5 },
  ...
  return (
    <div className="bg-hw-dark-2 p-3 rounded-lg border border-white h-full flex flex-col">
      ...
      <div className="flex-grow">
        <BarChart data={chargingLevelData} onBarClick={handleBarClick} />
      </div>
...
export default ChargingLevelChart;
