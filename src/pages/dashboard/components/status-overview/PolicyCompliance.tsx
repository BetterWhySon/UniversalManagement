  ...
  return (
    <div className="bg-gray-800 p-3 rounded-lg border border-white h-full flex flex-col overflow-hidden">
      ...
      <div className="flex justify-between flex-grow overflow-auto">
        ...
        >
          <p className="text-white text-xl font-semibold mb-2">권장 SoC 초과</p>
          <p className="text-green-500 text-7xl font-bold mb-2">94<span className="text-3xl"> %</span></p>
          <p className="text-gray-400 text-base">정책 미준수 72건</p>
        </div>
        <div 
          className="w-[48%] flex flex-col justify-center items-center p-2 bg-gray-700 rounded cursor-pointer hover:bg-gray-600 transition-colors"
          onClick={handleClick}
          ...
          onMouseLeave={() => setShowTooltip(false)}
        >
          <p className="text-white text-xl font-semibold mb-2">권장 충전율 초과</p>
          <p className="text-yellow-500 text-7xl font-bold mb-2">82<span className="text-3xl"> %</span></p>
          <p className="text-gray-400 text-base">정책 미준수 35건</p>
        </div>
      </div>
