...
const ChargingSummary: React.FC = () => {
    ...
    const handleStatusClick = (status: 'good' | 'normal' | 'bad') => {
        navigate(PATH.DASHBOARD.CHARGING_STATUS, { 
            state: { status } 
        });
    };
        ...
        <div className="bg-slate-800 p-3 rounded-lg border border-white h-full flex flex-col">
            ...
            <div className="flex-grow flex items-center">
                ...
                <div className="w-1/4 flex flex-col justify-center items-center space-y-6">
                    <div 
                        className="w-24 h-9 border border-blue-500 rounded flex items-center justify-between px-2 cursor-pointer hover:bg-blue-900 transition-colors"
                    ...
                    <div 
                        className="w-24 h-9 border border-green-500 rounded flex items-center justify-between px-2 cursor-pointer hover:bg-green-900 transition-colors"
