...
import ManufacturerDataRealtimeRegistrationPopup from './components/ManufacturerDataRealtimeRegistrationPopup';

export default function ManufacturerDataRealtimePage() {
  ...
  const columns: TableColumn<typeAdmModelCustomRealTimeList>[] = [
    ...
    {
      name: '제조사',
      dataIndex: 'referred_manufacturer_name',
      align: TEXT_ALIGN.CENTER,
      width: '120px',
      render: (row: typeAdmModelCustomRealTimeList) => row.referred_manufacturer_name
    },
    {
      name: '데이터 타입',
      dataIndex: 'type',
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)]">
      ...
      {/* 등록/수정 팝업 컴포넌트는 별도로 구현 필요 */}
      {isRegistrationPopupOpen && (
        <ManufacturerDataRealtimeRegistrationPopup
          onClose={() => {
            setIsRegistrationPopupOpen(false);
            setEditData(null);
          }}
